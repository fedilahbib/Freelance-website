...
@Component({
  selector: 'app-manager-dashboard-post-job',
  templateUrl: './manager-dashboard-post-job.component.html',
  styleUrls: ['./manager-dashboard-post-job.component.scss']
})
export class ManagerDashboardPostJobComponent implements OnInit {
